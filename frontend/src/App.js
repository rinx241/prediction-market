  ...
  useEffect(() => {
    const init = async () => {
      ...
      const bets = await Promise.all([
        predictionMarket.bets(SIDE.SUNING),
        predictionMarket.bets(SIDE.DAMWON)
      ]);
      ...
      const myBets = await Promise.all([
        predictionMarket.betsPerGambler(signerAddress, SIDE.DAMWON),
        predictionMarket.betsPerGambler(signerAddress, SIDE.SUNING),
      ]);
      setMyBets(myBets);
    ...
    <div className='container'>
      ...
      <div className='row'>
        <div className='col-sm-12'>
          ...
          <div className="jumbotron">
            <h1 className="display-4 text-center">Who will win the League of Legends World Championship?</h1>
      ...
      <div className='row'>
        <div className='col-sm-6'>
          <div className="card">
            <img src='./img/Damwon.png' width='500' height = '500' />
            <div className="card-body">
              <h5 className="card-title">Damwon</h5>
              <form className="form-inline" onSubmit={e => placeBet(SIDE.DAMWON, e)}>
                <input 
                  type="text" 
        ...
        <div className='col-sm-6'>
          <div className="card">
            <img src='./img/Suning.png' width='500' height = '500' />
            <div className="card-body">
              <h5 className="card-title">Suning</h5>
              <form className="form-inline" onSubmit={e => placeBet(SIDE.SUNING, e)}>
                <input 
                  type="text" 
                  className="form-control mb-2 mr-sm-2" 
                  placeholder="Bet amount (wei)"
      ...
      <div className='row'>
        <h2>Your bets</h2>
        <ul>
          <li>Damwon: {myBets[0].toString()} ETH (wei)</li>
          <li>Suning: {myBets[1].toString()} ETH (wei)</li>
        </ul>
      </div>

    <div className='row'>
      <h2>Claim your gains after the games</h2>
      <button 
        type="submit" 
        className="btn btn-primary mb-2"
